namespace OfflineMessaging.Migrations
{
    ...
    public partial class DefaultConnection : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BlockedUserId = c.String(nullable: false, maxLength: 128),
                        BlockedTime = c.DateTime(nullable: false),
                        userId = c.String(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.BlockedUserId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Login_Logs", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Blocks", "BlockedUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Login_Logs", new[] { "UserId" });
